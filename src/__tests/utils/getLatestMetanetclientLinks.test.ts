...
describe('utils/getLatestMetanetclientLinks.ts', () => {
  ...
  test('fetches and constructs correct download links for valid GitHub release', async () => {
    ...
    const expectedLinks: MetanetclientLinks = {
      macos: 'https://github.com/bsv-blockchain/metanet-desktop/releases/download/metanet-desktop-v0.5.1/Metanet.Desktop_0.5.1_aarch64.dmg',
      windows: 'https://github.com/bsv-blockchain/metanet-desktop/releases/download/metanet-desktop-v0.5.1/Metanet.Desktop_0.5.1_x64-setup.exe',
      linux: 'https://github.com/bsv-blockchain/metanet-desktop/releases/download/metanet-desktop-v0.5.1/Metanet.Desktop_0.5.1_amd64.AppImage',
      ios: 'https://apps.apple.com/app/metanet/id0000000000',
      android: 'https://play.google.com/store/apps/details?id=com.metanet.browser',
    };

    const result = await getLatestMetanetclientLinks();

    expect(global.fetch).toHaveBeenCalledWith('https://api.github.com/repos/bsv-blockchain/metanet-desktop/releases/latest');
