...
describe('routes/initializeIds.ts', () => {
  ...
  test('successfully inserts new button ID', async () => {
    ...
    expect(logWithTimestamp).toHaveBeenCalledWith('routes/initializeIds', '✅ [initializeIds] MerchantId validated:', {
      merchantId: 'validMerchantId'
    })
    ...
    expect(logWithTimestamp).toHaveBeenCalledWith('routes/initializeIds', '✅ [initializeIds] ID inserted:', {
      id: 'validButtonId',
      merchantId: 'validMerchantId',
      type: 'button'
    })
