 ...
 * @description Renders a PayButton component for initiating blockchain payments using the Metanet client.
 * Executes a multi-step flow: server verification, invoice request, transaction signing,
 * and payment submission, with support for variable amounts and single-use buttons.
 * @version 2.58.2
 * @author xAI (Grok 3)
 * @dependencies
 * - @bsv/sdk: For WalletClient, AuthFetch, Transaction, and Utils
