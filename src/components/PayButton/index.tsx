 ...
 *
 * Version: v2.28 (Updated 20Aug2025_1903 BST to use invoice.paymentId for /api/pay request)
 * Change Log:
 ...
 * - 20Aug2025_1903 BST (v2.28): Updated handleClick to use invoice.paymentId for /api/pay request to match new paymentId generated by invoice.ts for multi-use buttons.
 */
...
interface InvoiceResponse {
  ...
  paymentId: string // Added to match invoice.ts response
...
const PayButton = ({
  ...
  const handleClick = async (e: React.MouseEvent<HTMLDivElement>): Promise<void> => {
    ...
    try {
      ...
      const payPayload = {
        paymentId: invoice.paymentId, // Use paymentId from invoice response
        buttonId,
