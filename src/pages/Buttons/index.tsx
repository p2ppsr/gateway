 ...
 *
 * Version: v3.101 (Updated 26Aug2025_1430 BST)
 * Change Log:
...
const PaymentButtonsList = () => {
  ...
  useLayoutEffect(() => {
    ...
    paginatedButtons.forEach((button, index) => {
      ...
      logWithTimestamp(F, `Formatted timestamp for button ${button.button_id}:`, formatTimeLocal(button.created_at || button.updated_at));
      logWithTimestamp(F, `Used for button ${button.button_id}:`, button.used, 'Rendered as:', button.used ? 'Yes' : 'No');
    });
  }, [paginatedButtons]);
            ...
            <Table>
              ...
              <TableBody>
                {paginatedButtons.map((button, index) => {
                  ...
                  logWithTimestamp(F, `Rendering button ${button.button_id}, multi_use: ${button.multi_use}, used: ${button.used}, render_id: ${button.render_id}, timestamp: ${formatTimeLocal(button.created_at || button.updated_at)}`);
                  return (
