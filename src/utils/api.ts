...
export async function apiFetch(pathOrUrl: string, init: ApiInit = {}, wallet?: WalletClient): Promise<Response> {
...
export async function apiJson<T = unknown>(pathOrUrl: string, init: ApiInit = {}, wallet?: WalletClient): Promise<T> {
