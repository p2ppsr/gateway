...
if (window.location.host.startsWith('localhost') || process.env.NODE_ENV === 'development') {
  // local
  constants = {
    ...
    keyServerURL: process.env.REACT_APP_TEMPO_KEY_SERVER_URL || 'https://staging-tempo-keyserver.babbage.systems' //'http://localhost:8080'
  }
  ...
  constants = {
    ...
    tempoTopic: 'TSP',
    tspProtocolID: '1LQtKKK7c1TN3UcRfsp8SqGjWtzGskze36',
    keyServerURL: process.env.REACT_APP_TEMPO_KEY_SERVER_URL || 'https://staging-tempo-keyserver.babbage.systems'
  }
} else {
  // production
  constants = {
    ...
    tempoTopic: 'TSP',
    tspProtocolID: '1LQtKKK7c1TN3UcRfsp8SqGjWtzGskze36',
    keyServerURL: process.env.REACT_APP_TEMPO_KEY_SERVER_URL || 'https://tempo-keyserver.babbage.systems'
  }
}
