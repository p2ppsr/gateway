...
export const CONFIG = {
  SERVER_IDENTITY_KEY:
    (process as any)?.env?.SERVER_IDENTITY_KEY ?? '03f7c1fe6aaccabb06b9897a5c1f4bfa45230556a771d5b08aec5f48b94f09b61b',
  PRIVATE_IDENTITY_KEY:
    (process as any)?.env?.PRIVATE_IDENTITY_KEY ?? '3c164fce7834d831bbc96975f9717ad8af7d94d7df0d36de0b4c13e009540589',
  ...
  WALLET_ORIGIN: IN_BROWSER ? `${SCHEMES.HTTP}://localhost:${PORTS.WALLET_PRIMARY}` : ''
} as const

/**
 * Secondary wallet origin (optional).
 */
export const WALLET_SECONDARY_ORIGIN = IN_BROWSER ? `${SCHEMES.HTTP}://localhost:${PORTS.WALLET_SECONDARY}` : ''
