...
export const ClientConfigProvider: React.FC<React.PropsWithChildren<{ value: ClientConfig }>> = ({
  value,
  children
}) => <ClientConfigContext.Provider value={value ?? defaultClientConfig}>{children}</ClientConfigContext.Provider>
